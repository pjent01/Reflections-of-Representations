...
# Installation
## Method 1 (online)
The online version is available at reflections.streamlit.app.
To run this program locally, follow Method 2.
## Method 2 (local)
Clone this repository using ''' git clone https://github.com/pjent01/Reflections-of-Representations '''. Then install the necessary
requirements with ''' pip install -r requirements.txt '''. Afterwards, use ''' streamlit run main.py ''' within the repository.
